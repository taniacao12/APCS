PImage img;
Grid gameBoard, nextBoard;
// Grid holdBoard;
Tetromino current, holder;
Shape next;
...
void setup() {
  ...
  // initiate all grids
  gameBoard = new Grid(50, 50, 321, 642, 20, 10);
  nextBoard = new Grid(400, 100, 116, 58, 2, 4);
  // holdBoard = new Grid(400, 225, 116, 58, 2, 4);
...
void draw() {
  if (gameStart == false) {
    ...
    text("NEXT", 420, 90);
    // text("HOLD", 420, 215);
    text("CLICK ESC KEY TO CLOSE THE GAME", 300, height - 20);
  }
}
